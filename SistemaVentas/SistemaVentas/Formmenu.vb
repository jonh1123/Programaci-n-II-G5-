...
Public Class Formmenu
    ...
    Private Sub lblcantpro_Click(sender As Object, e As EventArgs) Handles lblcantpro.Click

    End Sub

    Private Sub lblcantv_Click(sender As Object, e As EventArgs) Handles lblcantv.Click
    ...
    Private Sub btnlistacuenta_Paint(sender As Object, e As PaintEventArgs) Handles btnlistacuenta.Paint
